    ...
    return {
      ...
      nganhInfo: {
        ...
        viTriViecLam: [
          ...
          'Giảng dạy trong các cơ sở đào tạo thủy sản (đại học, cao đẳng, trung cấp, trường nghề…)'
        ],
        noiLamViec: [

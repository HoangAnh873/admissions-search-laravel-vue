  ...
  data() {
    return {
      ...
      nganhInfo: {
        ...
        gioiThieu: 'Chuyên ngành Kinh tế đào tạo cử nhân có kiến thức kinh tế học chuyên sâu, kinh tế tài nguyên, nắm vững các lĩnh vực ứng dụng của khoa học kinh tế. Sinh viên được học các kiến thức về phương pháp, kỹ thuật thu thập, xử lý và ghi nhận thông tin kinh tế trong doanh nghiệp, thông tin kinh tế vĩ mô. Được trang bị kiến thức và mô hình kinh tế để phân tích diễn biến và xu hướng vận động của các chỉ số kinh tế quan trọng của nền kinh tế. Có kiến thức về ứng dụng khoa học kinh tế trong các lĩnh vực kinh tế ứng dụng, kinh tế học hành vi, kinh tế vùng và kinh tế học đô thị.',
        viTriViecLam: [

  ...
  data() {
    return {
      ...
      nganhInfo: {
        ...
        gioiThieu: 'Ngành Kỹ thuật phần mềm (KTPM) đào tạo sinh viên trở thành kỹ sư KTMP chất lượng cao, có sức khỏe, đạo đức và trách nhiệm với xã hội, có kiến thức và kỹ năng chuyên môn để phát triển các hệ thống phần mềm; có thể đảm nhận vị trí nghề nghiệp trong lĩnh vực công nghệ phần mềm; có khả năng học tập suốt đời và khả năng làm việc trong lĩnh vực phần mềm trong và ngoài nước. Sinh viên được học kiến thức và kỹ năng chung dành cho người kỹ sư công nghệ thông tin; kiến thức chuyên sâu về phân tích, thiết kế, cài đặt, kiểm thử, đảm bảo chất lượng, bảo trì phần mềm và quản lý dự án phần mềm; kiến thức nền tảng để phát triển hoàn chỉnh các hệ thống phần mềm theo một trong ba hướng: phần mềm nhúng và IoT, phần mềm nghiệp vụ, hoặc phần mềm mô phỏng.',
        viTriViecLam: [

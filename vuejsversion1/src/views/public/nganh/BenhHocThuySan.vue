  ...
  data() {
    return {
      ...
      nganhInfo: {
        ...
        gioiThieu: 'Ngành bệnh học thủy sản đào tạo kỹ sư có khả năng xét nghiệm/chẩn đoán, phòng và trị một số bệnh phổ biến trên các đối tượng nuôi thủy sản, quản lý và vận hành cơ sở sản xuất và kinh doanh thủy sản, phòng thí nghiệm bệnh thủy sản và có khả năng tham gia ở lĩnh vực kinh doanh dịch vụ thuốc và hóa chất sử dụng trong nuôi trồng thủy sản. Sinh viên được học kiến thức về (i) chẩn đoán các bệnh thường gặp ở động vật thủy sản; (ii) xét nghiệm bệnh ở động vật thủy sản, (iii) quản lý dịch bệnh tổng hợp trong nuôi thủy sản; (iv) quản lý và sử dụng thuốc và hóa chất trong nuôi thủy sản. Đồng thời sinh viên còn có kiến thức về sản xuất giống và nuôi một số đối tượng nuôi thủy sản chủ lực như tôm biển, tôm càng xanh và cá tra.',
        viTriViecLam: [
          'Kỹ sư chuyên về xét nghiệm/chẩn đoán bệnh thủy sản;',
          'Kỹ sư phụ trách bệnh thủy sản, quản lý các vùng nuôi thủy sản;',
          'Chủ cơ sở sản xuất và kinh doanh thủy sản;',
          'Giảng viên các trường đại học, cao đăng, trung cấp đào tạo về thủy sản.'
        ],
        noiLamViec: [
          'Chi cục nuôi thủy sản;',
          'Chi cục thú y;',
          'Trường đại học, cao đẳng, trung cấp,… đào tạo về thủy sản;',
          'Các công ty sản xuất và kinh doanh giống thủy sản;',
          'Các công ty sản xuất và kinh doanh thức ăn thủy sản;',
          'Các công ty sản xuất và kinh doanh thuốc thú y thủy sản;',

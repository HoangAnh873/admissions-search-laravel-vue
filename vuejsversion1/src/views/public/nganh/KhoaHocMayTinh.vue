  ...
  data() {
    return {
      ...
      nganhInfo: {
        ...
        gioiThieu: 'Khoa học Máy tính là một trong những ngành học quan trọng tại các trường đại học đào tạo về công nghệ thông tin (CNTT) nói riêng và kỹ thuật nói chung. Đây là ngành học dành cho các bạn đam mê nghiên cứu chuyên sâu về CNTT, khả năng tính toán của hệ thống máy tính, trí thông minh nhân tạo, học máy, đồ hoạ và thị giác máy tính,… rất phù hợp các nhu cầu về nguồn nhân lực cho cuộc cách mạng công nghệ 4.0. Chương trình nhằm đào tạo kỹ sư có kiến thức cốt lõi ngành Khoa học máy tính: kiến trúc máy tính, hệ điều hành, ngôn ngữ lập trình phần mềm và phần cứng và các kiến thức chuyên sâu về: trí tuệ nhân tạo, học máy, máy học ứng dụng, khai thác dữ liệu, học sâu, hệ thống hỏi đáp; đồ hoạ, lập trình trò chơi, xử lý ảnh, thị giác máy tính. Sinh viên sau khi ra trường có khả năng tư duy phát triển từ lý thuyết đến việc xây dựng hệ thống thông minh, có khả năng ứng dụng các kết quả nghiên cứu vào thực tiễn cũng như đủ kiến thức và kỹ năng cần thiết để thích ứng với sự thay đổi của công nghệ mới trong lĩnh vực khoa học máy tính và CNTT.',
        viTriViecLam: [
          'Chuyên viên phân tích dữ liệu;',
          'Chuyên viên đồ hoạ và thị giác máy tính',
          'Lập trình viên, quản lý dự án;',
          'Chuyên viên thiết kế, phát triển phần mềm;',
          'Chuyên viên nghiên cứu và phát triển các công nghệ tri thức (sản phẩm mang tính thông minh), xử lý hình ảnh, thị giác máy tính, thực tế ảo, lập trình trò chơi.',
          'Giảng viên, nghiên cứu viên'
        ],
        noiLamViec: [
          'Công ty sản xuất, gia công, bảo trì phần mềm;',
          'Công ty tư vấn - thiết kế các giải pháp công nghệ thông tin;',
          'Cơ quan Nhà nước có liên quan đến lĩnh vực công nghệ thông tin;',
          'Trường đại học, cao đẳng, trung cấp, … đào tạo về công nghệ thông tin.'
        ]
      },
      loading: false,
      error: null

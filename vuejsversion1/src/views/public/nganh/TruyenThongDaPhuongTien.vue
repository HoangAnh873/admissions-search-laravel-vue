...
export default {
  name: 'TruyenThongDaPhuongTienPage',
  components: {
    PublicLayout
  },
  data() {
    return {
      nganhId: null,
      nganhInfo: {
        tenNganh: 'Truyền thông đa phương tiện',
        maNganh: '7320104',
        ...
        noiLamViec: [
          ...
          'Các Trường đại học, cao đẳng, trung cấp, … đào tạo về truyền thông số và tiếp thị số'
        ]
      },
      loading: false,
      error: null
